...
**Выполнил:** Яснов Михаил Алексеевич, группа P3217
...
- 0 — числовой вывод/ввод (Digit)
- 1 — строковый вывод (C-strings, адрес в памяти) и символьный ввод/вывод (Char)
- 2 — зарезервирован под длинные числа (Long)
