...
- Прерывание 0: Системный таймер
- Прерывание 1: Ввод с клавиатуры  
- Прерывание 2: Готовность к выводу
- Прерывания 3-7: Зарезервированы

**Обработка прерываний:**

1. Сохранение контекста (PC, флаги, TOS)
2. Переход по вектору прерывания
3. Выполнение обработчика
4. Восстановление контекста по `IRET`
...
**2. Простые векторные операции (`simple_vector.alg`):**
...
**4. Тест векторных операций (`vector_test.alg`):**
...
========================== STATISTICS ===========================
Total instructions executed:     15,847
Total CPU ticks:                 47,231  
Average IPC:                     0.335
Memory usage (peak):             1,024 bytes
Vector operations:               1,247
============================ SUMMARY ============================
All tests PASSED ✓
...
Проект полностью соответствует требованиям варианта и демонстрирует качественную реализацию алголичного языка, стековой архитектуры, Гарвардской памяти, системы прерываний и векторных расширений.